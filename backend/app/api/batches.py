...
def generate_batch_qr_codes(
    ...
    # --------------------------------------------------------
    # QR codes are generated by the frontend
    # --------------------------------------------------------
    #
    # The backend does NOT create QR image files anymore.
    #
    # Each serialized medicine already has a unique qr_token
    # stored in the database.
    #
    # The frontend uses that token to create the verification
    # URL and render the QR code directly in the browser.
    # --------------------------------------------------------
    ...
    return {
        "message": "QR codes ready for generation",
        "batch_id": batch_id,
